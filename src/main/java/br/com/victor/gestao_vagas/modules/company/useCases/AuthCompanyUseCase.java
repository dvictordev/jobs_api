...
public class AuthCompanyUseCase {
    ...
    public AuthCompanyResponseDTO execute(AuthCompanyDTO authCompanyDTO) throws AuthenticationException {
        ...
        var company = this.companyRepositorie.findByUsername(authCompanyDTO.getUsername()).orElseThrow(() -> {
        ...
        var authCompanyReponseDTO = AuthCompanyResponseDTO.builder().access_token(token)
                .expires_at(expires_at.toEpochMilli()).build();
