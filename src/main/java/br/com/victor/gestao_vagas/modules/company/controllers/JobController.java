...
public class JobController {
    ...
    @Operation(summary = "Cadastro de vagas", description = "Essa funcao é responsavel por cadastrar as vagas dentro da empresa")
    ...
    public JobEntity create(@Valid @RequestBody CreateJobDTO createJobDTO, HttpServletRequest request) {
        ...
        var jobEntity = JobEntity.builder().benefits(createJobDTO.getBenefits()).companyId(UUID.fromString(companyId
                .toString()))
